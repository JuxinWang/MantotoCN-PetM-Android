package com.petm.property.pickview;
...
public class WheelTime {
     ...
     * @param startMonth
     */
    public static void setSTRT_MONTH(int startMonth){
     ...
     * @param endMonth
     */
    public static void setEND_MONTH(int endMonth){
        END_MONTH = endMonth;
    }
    ...
    public static void setSTART_DA(int sTART_DAY) {
